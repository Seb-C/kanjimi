...
export default {
	...
	forms: {
		...
		[ConjugationType.TEIRU_NEGATIVE]: 'teiru (negative)',
		[ConjugationType.TEIRU_NEGATIVE_PAST]: 'teiru (negative past)',
		[ConjugationType.TEIRU_NEGATIVE_TE]: 'teiru (negative te)',
		[ConjugationType.TEIRU_POLITE]: 'teiru (polite)',
		[ConjugationType.TEIRU_POLITE_NEGATIVE]: 'teiru (polite negative)',
		[ConjugationType.TEIRU_POLITE_NEGATIVE_PAST]: 'teiru (polite negative past)',
		[ConjugationType.TEIRU_POLITE_PAST]: 'teiru (polite past)',
		[ConjugationType.TEIRU_POLITE_VOLITIONAL]: 'teiru (polite volitional)',
		[ConjugationType.TEIRU_WISH]: 'teiru (wishful)',
