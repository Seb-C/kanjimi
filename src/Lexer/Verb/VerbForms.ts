...
verbForms.addForm(new VerbForm('いませんでした', 'いる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('いませんでした', 'う'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('えませんでした', 'える', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('きませんでした', 'きる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('きませんでした', 'く'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ぎませんでした', 'ぐ'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('けませんでした', 'ける', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('しませんでした', 'しる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('しませんでした', 'す'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('せませんでした', 'せる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ちませんでした', 'ちる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ちませんでした', 'つ'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('てませんでした', 'てる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('にませんでした', 'にる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('にませんでした', 'ぬ'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ねませんでした', 'ねる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ひませんでした', 'ひる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('びませんでした', 'ぶ'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('へませんでした', 'へる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('みませんでした', 'みる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('みませんでした', 'む'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('めませんでした', 'める', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('りませんでした', 'りる', VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('りませんでした', 'る'  , VerbFormType.POLITE_NEGATIVE_PAST));
verbForms.addForm(new VerbForm('れませんでした', 'れる', VerbFormType.POLITE_NEGATIVE_PAST));
...
verbForms.addForm(new VerbForm('わなかった', 'う'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('かなかった', 'く'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('がなかった', 'ぐ'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('さなかった', 'す'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('たなかった', 'つ'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ななかった', 'ぬ'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ばなかった', 'ぶ'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('まなかった', 'む'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('らなかった', 'る'  , VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('いなかった', 'いる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('えなかった', 'える', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('きなかった', 'きる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('けなかった', 'ける', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('しなかった', 'しる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('せなかった', 'せる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ちなかった', 'ちる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('てなかった', 'てる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('になかった', 'にる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ねなかった', 'ねる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('ひなかった', 'ひる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('へなかった', 'へる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('みなかった', 'みる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('めなかった', 'める', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('りなかった', 'りる', VerbFormType.NEGATIVE_PAST));
verbForms.addForm(new VerbForm('れなかった', 'れる', VerbFormType.NEGATIVE_PAST));
