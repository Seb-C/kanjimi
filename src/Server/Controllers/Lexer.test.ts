...
describe('LexerController', async function() {
	...
	it('analyze (increments the UserActivity table)', async function() {
		await fetch(process.env.KANJIMI_API_URL + '/lexer/analyze', {
			method: 'POST',
			headers: {
				Authorization: `Bearer ${apiKey.key}`,
			},
	...
	it('getKanji (normal case)', async function() {
		const response = await fetch(process.env.KANJIMI_API_URL + '/lexer/kanji/' + encodeURIComponent('恐'), {
			method: 'GET',
			headers: {
				Authorization: `Bearer ${apiKey.key}`,
			},
	...
	it('getKanji (wrong authentication case)', async function() {
		const response = await fetch(process.env.KANJIMI_API_URL + '/lexer/kanji/' + encodeURIComponent('食'), {
			method: 'GET',
			headers: {
				Authorization: `Bearer wrongtoken`,
			},
	...
	it('getKanji (not a kanji error case)', async function() {
		const response = await fetch(process.env.KANJIMI_API_URL + '/lexer/kanji/X', {
			method: 'GET',
			headers: {
				Authorization: `Bearer ${apiKey.key}`,
			},
	...
	it('getKanji (more than one character error case)', async function() {
		const response = await fetch(process.env.KANJIMI_API_URL + '/lexer/kanji/test', {
			method: 'GET',
			headers: {
				Authorization: `Bearer ${apiKey.key}`,
			},
	...
	it('getKanji (unknown Kanji error case)', async function() {
		const response = await fetch(process.env.KANJIMI_API_URL + '/lexer/kanji/' + encodeURIComponent('龯'), {
			method: 'GET',
			headers: {
				Authorization: `Bearer ${apiKey.key}`,
			},
