MVP:
    landing page + video
    automatic test of the tooltip position calculations? (selenium geckodriver-webextension? Karma? https://dev.to/pureooze/unit-testing-browser-extensions-39a5 )
